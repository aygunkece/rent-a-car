                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1"
                                        ...
                                        <tr>
                                            <td class="pad"
                                                ...
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                        alt="reset-password" class="big"
                                                        src="{{ asset("assets/admin/images/gif-resetpass.gif") }}"
                                        ...
                                        <tr>
                                            <td class="pad" style="text-align:center;width:100%;">
                                                <h1 style="margin: 0; color: #393d47; direction: ltr; font-family: Tahoma, Verdana, Segoe, sans-serif; font-size: 25px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
                                                    <strong>{{ __('email-company-create-password.kullaniciSifreniziOlusturun') }}</strong></h1>
                                            </td>
                                        </tr>
                                    </table>
                                                    ...
                                                    <div class=""
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;">
                                                            <span style="font-size:14px;">
                                                                {{ __('email-company-create-password.spanSifreOlustur') }}
                                                            </span>
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <td class="pad">
                                                <div align="center" class="alignment"><!--[if mso]>
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 style="height:58px;width:272px;v-text-anchor:middle;"
                                                                 arcsize="35%" strokeweight="0.75pt"
                                                                 strokecolor="#FFC727" fillcolor="#ffc727">
                                                        <w:anchorlock/>
                                                        <v:textbox inset="0px,0px,0px,0px">
                                                            <center
                                                                style="color:#393d47; font-family:Tahoma, Verdana, sans-serif; font-size:18px">
                                                    <![endif]-->
                                                    <a href="{{ route("company.passwordUpdate.token", ["token" => $token]) }}"
                                                       ...
                                                       target="_blank">
                                                        <span
                                                            style="padding-left:50px;padding-right:50px;font-size:18px;display:inline-block;letter-spacing:normal;">
                                                            <span style="word-break:break-word;"><span data-mce-style=""
                                                                                                       style="line-height: 36px;">
                                                                    <strong>{{ __('email-company-create-password.strongSifreOlustur') }}</strong></span></span></span>
                                            ...
                                            <td class="pad"
                                                ...
                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p style="margin: 0; mso-line-height-alt: 19.5px;"><span
                                                                style="font-size:13px;">{{ __('email-company-create-password.spanOnKayıt') }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack"
                            ...
                            <tr>
                                <td class="column column-1"
                                                        ...
                                                        <tr>
                                                            <td style="padding:0 5px 0 5px;"><a
                                                                    ...
                                                                    target="_blank"><img alt="Facebook" height="32"
                                                                                         src="{{ asset("assets/admin/images/facebook2x.png") }}"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="html_block block-3"
                                           role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                           width="100%">
                                        <tr>
                                            <td class="pad">
                                                <div align="center"
                                                     style="font-family:Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;">
                                                    <div
                                                        style="margin-top: 25px;border-top:1px dashed #D6D6D6;margin-bottom: 20px;"></div>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                                ...
                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                    <div class=""
                                                        ...
                                                        <p style="margin: 0; text-align: center; mso-line-height-alt: 14.399999999999999px;">
                                                            Adres bilgileri gelicek</p>
                                                        <p style="margin: 0; text-align: center; mso-line-height-alt: 14.399999999999999px;">
                                                            Adres bilgileri gelicek</p>
                                                        <p style="margin: 0; text-align: center; mso-line-height-alt: 14.399999999999999px;">
                                                             </p>
                                                        <p style="margin: 0; text-align: center; mso-line-height-alt: 14.399999999999999px;">
                                                            adres telefon mail bilgileri gelicek<a
                                                                href="http://www.example.com" style=""></a></p>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="html_block block-5"
                                           role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                           width="100%">
                                        <tr>
                                            <td class="pad">
                                                                ...
                                                                <tr>
                                                                    <td style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 5px; padding-right: 6px;">
                                                                        <a href="" style="text-decoration: none;"
                                                                           target="_blank">
                                                                            <img align="center" alt="Designed with BEE"
                                                                                 class="icon" height="32"
                                                                                 src="{{ asset("assets/admin/images/bee.png") }}"
                                                                    ...
                                                                    <td style="font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 15px; color: #9d9d9d; vertical-align: middle; letter-spacing: undefined; text-align: center;">
                                                                        <a href=""
                                                                           ...
                                                                           target="_blank">Vip Rent A Car</a></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
